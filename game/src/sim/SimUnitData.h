...
// Gold cost tiers (rough HoMM3 scale): T1≈60, T2≈120, T3≈200, T4≈350, T5≈600, T6≈1200
static constexpr UnitSimData SIM_UNITS[] = {
    // ── Holy Order ────────────────────────────────────────────────────────────
    //  name                 faction                tier  hp  atk def dmn dmx spd rng sht fly 2nd  tags                                          gr  uw  gold
    {"Penitent",        FactionId::HolyOrder, 1, 10, 2, 3, 1,  3, 4,  0, 0, false, false, UnitTag::Humanoid|UnitTag::Holy,  14, 1,   60},
    {"Torch Bearer",    FactionId::HolyOrder, 2, 18, 4, 4, 2,  5, 5,  0, 0, false, false, UnitTag::Humanoid|UnitTag::Holy,  10, 2,  110},
    {"Plague Doctor",   FactionId::HolyOrder, 3, 28, 5, 5, 4,  7, 6,  5, 8, false, false, UnitTag::Humanoid|UnitTag::Holy,   7, 3,  200},
    ...
    // ── Crimson Wardens ───────────────────────────────────────────────────────
    {"Skeleton",        FactionId::CrimsonWardens, 1,  8, 2, 2, 1,  3, 4, 0,  0, false, false, UnitTag::Undead,  15, 1,   50},
    {"Bone Archer",     FactionId::CrimsonWardens, 2, 14, 4, 3, 3,  6, 5, 5, 12, false, false, UnitTag::Undead,  11, 2,  100},
    {"Wight",           FactionId::CrimsonWardens, 3, 26, 6, 5, 4,  8, 6, 0,  0, false, false, UnitTag::Undead,   7, 3,  190},
    ...
    // ── Thornkin ──────────────────────────────────────────────────────────────
    {"Sproutling",      FactionId::Thornkin, 1,  9, 2, 3, 1,  3, 3, 0, 0, false, false, UnitTag::Beast,  14, 1,   55},
    {"Briar",           FactionId::Thornkin, 2, 20, 4, 5, 3,  6, 4, 0, 0, false, false, UnitTag::Beast,  10, 2,  115},
    {"Vine Crawler",    FactionId::Thornkin, 3, 34, 7, 6, 5,  9, 5, 0, 0, false, false, UnitTag::Beast,   7, 3,  210},
    ...
    // ── Eternal Empire ────────────────────────────────────────────────────────
    {"Conscript",       FactionId::EternalEmpire, 1, 10, 2, 3, 1,  3, 4, 0, 0, false, false, UnitTag::Humanoid|UnitTag::Undead,   13, 1,   60},
    {"Revenant",        FactionId::EternalEmpire, 2, 16, 4, 4, 3,  6, 5, 0, 0, false, false, UnitTag::Undead,                     10, 2,  110},
    {"Shade Archer",    FactionId::EternalEmpire, 3, 24, 5, 4, 4,  8, 6, 5, 9, false, false, UnitTag::Undead,                      7, 3,  200},
    ...
    // ── Bloodsworn ────────────────────────────────────────────────────────────
    {"Bloodling",       FactionId::Bloodsworn, 1, 10, 3, 2, 2,  4, 5, 0, 0, false, false, UnitTag::Humanoid|UnitTag::BloodBound,  14, 1,   65},
    {"Berserker",       FactionId::Bloodsworn, 2, 18, 5, 3, 3,  7, 7, 0, 0, false, false, UnitTag::Humanoid|UnitTag::BloodBound,  10, 2,  120},
    {"Blood Shaman",    FactionId::Bloodsworn, 3, 25, 6, 4, 4,  8, 6, 4, 7, false, false, UnitTag::Humanoid|UnitTag::BloodBound,   7, 3,  195},
    ...
    // ── Voidkin ───────────────────────────────────────────────────────────────
    {"Void Wisp",       FactionId::Voidkin, 1,  8, 2, 2, 1,  3, 6, 0, 0, true,  false, UnitTag::Void,  13, 1,   70},
    {"Phase Walker",    FactionId::Voidkin, 2, 14, 4, 3, 2,  5, 8, 0, 0, true,  false, UnitTag::Void,  10, 2,  130},
    {"Rift Archer",     FactionId::Voidkin, 3, 24, 6, 5, 4,  8, 7, 5, 9, true,  false, UnitTag::Void,   7, 3,  220},
    ...
    // ── Iron Assembly ─────────────────────────────────────────────────────────
    {"Automaton",       FactionId::IronAssembly, 1, 12, 2, 4, 1,  3, 3, 4,  6, false, false, UnitTag::Mechanical,  12, 1,   75},
    {"Gun Construct",   FactionId::IronAssembly, 2, 20, 4, 5, 3,  6, 4, 5,  8, false, false, UnitTag::Mechanical,   9, 2,  140},
    {"Steam Walker",    FactionId::IronAssembly, 3, 38, 6, 7, 5, 10, 5, 0,  0, false, false, UnitTag::Mechanical,   6, 3,  230},
    ...
    {"Graft Soldier",   FactionId::Amalgamate, 2, 21, 4, 4, 3,  6, 5, 0, 0, false, false, UnitTag::OrganicMech,   9, 2,  120},
    {"Bone Machine",    FactionId::Amalgamate, 3, 36, 7, 5, 5, 10, 6, 0, 0, false, false, UnitTag::OrganicMech,   6, 3,  200},
    ...
    // ── Convergence ───────────────────────────────────────────────────────────
    {"Awakened",        FactionId::Convergence, 1, 10, 3, 3, 2,  4, 5, 0, 0, false, false, UnitTag::Humanoid,  11, 1,   70},
    {"Synthesized",     FactionId::Convergence, 2, 19, 5, 5, 3,  6, 6, 0, 0, false, false, UnitTag::Humanoid,   8, 2,  125},
    {"Harmonized",      FactionId::Convergence, 3, 32, 7, 7, 5, 10, 7, 0, 0, false, false, UnitTag::Humanoid,   6, 3,  210},
