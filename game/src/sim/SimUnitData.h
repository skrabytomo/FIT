...
static constexpr UnitSimData SIM_UNITS[] = {
    ...
    {"Vine Crawler",    FactionId::Thornkin, 3, 28, 5, 5, 5,  9, 5, 0, 0, false, false, UnitTag::Beast,   7, 3,  185},
    {"Grove Guardian",  FactionId::Thornkin, 4, 62, 9, 9, 9, 15, 5, 0, 0, false, false, UnitTag::Beast,   5, 5,  370},
    ...
    {"Shade Archer",    FactionId::EternalEmpire, 3, 32, 5, 5, 4,  8, 6, 5, 2, false, false, UnitTag::Undead,                      7, 3,  210},
    ...
    {"Siege Bot",       FactionId::IronAssembly, 4, 65, 9,10, 9, 17, 4, 5,  5, false, false, UnitTag::Mechanical,   5, 5,  400},
    {"Titan Construct", FactionId::IronAssembly, 5, 95,12,13,15, 24, 5, 0,  0, false, false, UnitTag::Mechanical,   3, 7,  660},
    {"Colossus Prime",  FactionId::IronAssembly, 6,185,16,17,26, 42, 6, 0,  0, false, false, UnitTag::Mechanical,   2, 9, 1350},
    ...
    {"Harmonized",      FactionId::Convergence, 3, 33, 7, 7, 5, 10, 6, 4, 5, false, false, UnitTag::Humanoid,   6, 3,  210},
    {"Resonant",        FactionId::Convergence, 4, 58,11,11, 9, 16, 8, 0, 0, true,  false, UnitTag::Humanoid,   4, 5,  370},
    {"Transcendent",    FactionId::Convergence, 5, 96,14,14,14, 23,10, 0, 0, true,  false, UnitTag::Humanoid,   3, 7,  640},
    {"Unified Form",    FactionId::Convergence, 6,168,18,18,23, 37,12, 0, 0, true,  false, UnitTag::Humanoid,   2, 9, 1250},
};
// clang-format on
