...
static constexpr UnitSimData SIM_UNITS[] = {
    ...
    {"Titan Construct", FactionId::IronAssembly, 5, 88,12,12,15, 24, 5, 0,  0, false, false, UnitTag::Mechanical,   3, 7,  660},
    {"Colossus Prime",  FactionId::IronAssembly, 6,170,16,15,26, 42, 6, 0,  0, false, false, UnitTag::Mechanical,   2, 9, 1350},
    ...
    {"Transcendent",    FactionId::Convergence, 5, 80,12,12,14, 23,10, 0, 0, true,  false, UnitTag::Humanoid,   3, 7,  640},
    {"Unified Form",    FactionId::Convergence, 6,145,16,15,23, 37,12, 0, 0, true,  false, UnitTag::Humanoid,   2, 9, 1250},
};
// clang-format on
